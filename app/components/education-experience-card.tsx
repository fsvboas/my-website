...
const EducationExperienceCard = ({
  ...
  return (
    <Column className="justify-between border border-gray-300 dark:border-gray-600 p-4 rounded-lg bg-gray-200 dark:bg-[#202020]  space-y-2 hover:border-gray-400 dark:hover:border-gray-400 duration-300">
