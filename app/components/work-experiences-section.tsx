...
const WorkExperiencesSection = () => {
  const workExperiences: WorkExperiencesType[] = [
    ...
    },
    {
      ...
      jobDescription: (
        <>
          Iniciei minha carreira profissional na NEORIS, como desenvolvedor SAP
          trainee. Esta foi uma importante porta de entrada para o mercado de
          trabalho, permitindo-me adquirir os conhecimentos fundamentais sobre o
          funcionamento do setor de tecnologia. Durante minha trajetória na
          empresa, trabalhei tanto com desenvolvimento do front-end quanto o do
          back-end das aplicações, o que me proporcionou uma visão ampla e
          aprofundada de todas as etapas de criação e manutenção de sistemas.
        </>
      ),
    },
  ];
